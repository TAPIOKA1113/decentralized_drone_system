/// Time-stamp: <2023-10-19 10:16:56 kobayashi>
...
const double ConvergenceRange = 1;         // 合意したと判定する半径[m]
...
double eps = 1.0 / (adjacency.size() + 1); // eps<1/グラフの最大次数だと収束する(いろいろある)
double sumx = 0.0;
double sumy = 0.0;
...
printf("# 単純なCSMA/CAを用いた合意制御シミュレーション\n");
printf("# \n");
...
printf("# ConvergenceRate  ConvergenceTime  DiscardRate  CollisionRate  AvgNumAdj  AvgNumAdjRx\n");

printf("%.10lf  %3.7lf  %.10lf  %.10lf  %.10lf  %.10lf\n",
